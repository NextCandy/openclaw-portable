...
**手順：**
```bash
# 手順 1：Node.js インストール（10-15分）
curl -fsSL https://deb.nodesource.com/setup_22.x | sudo -E bash -
sudo apt-get install -y nodejs

# 手順 2：OpenClaw インストール（5-10分）
...
|------|------------------|-------------|
| **セットアップ時間** | 10-30分 | **60秒** |
| **ネットワーク必要** | ✅ はい（500MB+） | ❌ **いいえ** |
| **VPN必要（制限地域）** | ✅ はい | ❌ **いいえ** |
| **デバイス間移動** | ❌ 毎回再インストール | ✅ **USB差すだけ** |
| **データポータビリティ** | ❌ 手動同期 | ✅ **自動** |
| **プライバシー（共有PC）** | ❌ 痕跡あり | ✅ **ゼロ痕跡** |
| **設定の永続性** | ❌ デバイスごと | ✅ **USBベース** |
| **Node.js インストール** | ✅ 必要 | ❌ **プリインストール済み** |
| **OpenClaw インストール** | ✅ 必要 | ❌ **プリインストール済み** |
| **オフライン使用** | ❌ いいえ | ✅ **99% オフライン** |

**結論：** OpenClaw Portable は従来のインストールのすべての摩擦を解消し、
ポータビリティとプライバシーを追加します。
