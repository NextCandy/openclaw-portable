...
echo "[5/5] 打包 Release..."
cd dist
zip -r "OpenClaw-Portable-v6.0.0-windows-offline.zip" OpenClaw-Portable-v6.0.0-windows/
SIZE=$(du -h "OpenClaw-Portable-v6.0.0-windows-offline.zip" | cut -f1)

echo ""
echo "=========================================="
echo "  ✅ 构建完成！"
echo "=========================================="
echo "  文件: OpenClaw-Portable-v6.0.0-windows-offline.zip"
echo "  大小: ${SIZE}"
echo "  位置: dist/"
echo ""
echo "  包含内容:"
